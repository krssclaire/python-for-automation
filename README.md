...
This repository contains code of examples, projects and exercices of the book [Automate the boring stuff with Python](https://automatetheboringstuff.com/) by _Al Sweigart_.  
The purpose of this repository is to document my learning journey into Python for automation. 

The structure the repository followes the strucutre of the book:
* Introduction
